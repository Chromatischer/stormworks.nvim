...
require("sw-micro-project.common.nameouschangey.Common.LifeBoatAPI.Tools.Build.StringReplacer")
require("sw-micro-project.common.nameouschangey.Common.LifeBoatAPI.Tools.Build.CommentReplacer")
