...
require("sw-micro-project.common.nameouschangey.Common.LifeBoatAPI.Tools.Build.Combiner")
require("sw-micro-project.common.nameouschangey.Common.LifeBoatAPI.Tools.Build.Minimizer")
