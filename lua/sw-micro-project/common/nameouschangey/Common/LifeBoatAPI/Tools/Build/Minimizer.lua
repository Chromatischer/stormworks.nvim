...
require("sw-micro-project.common.nameouschangey.Common.LifeBoatAPI.Tools.Utils.StringUtils")
require("sw-micro-project.common.nameouschangey.Common.LifeBoatAPI.Tools.Utils.Filepath")
require("sw-micro-project.common.nameouschangey.Common.LifeBoatAPI.Tools.Utils.FileSystemUtils")
require("sw-micro-project.common.nameouschangey.Common.LifeBoatAPI.Tools.Build.RedundancyRemover")
require("sw-micro-project.common.nameouschangey.Common.LifeBoatAPI.Tools.Build.StringCommentsParser")
require("sw-micro-project.common.nameouschangey.Common.LifeBoatAPI.Tools.Build.VariableShortener")
require("sw-micro-project.common.nameouschangey.Common.LifeBoatAPI.Tools.Build.GlobalVariableReducer")
require("sw-micro-project.common.nameouschangey.Common.LifeBoatAPI.Tools.Build.ParsingConstantsLoader")
require("sw-micro-project.common.nameouschangey.Common.LifeBoatAPI.Tools.Build.NumberLiteralReducer")
require("sw-micro-project.common.nameouschangey.Common.LifeBoatAPI.Tools.Build.HexadecimalConverter")
