...
require("sw-micro-project.common.nameouschangey.Common.LifeBoatAPI.Tools.Utils.TableUtils")
require("sw-micro-project.common.nameouschangey.Common.LifeBoatAPI.Tools.Utils.StringUtils")
require("sw-micro-project.common.nameouschangey.Common.LifeBoatAPI.Tools.Utils.StringBuilder")
require("sw-micro-project.common.nameouschangey.Common.LifeBoatAPI.Tools.Build.VariableRenamer")
  ...
  _shorten = function(this, text, pattern, acceptableList)
    ...
    variables = LifeBoatAPI.Tools.TableUtils.iwhere(variables, function(v)
      return v.captures[1]
        ...
        and not this.constants.restrictedKeywords[v.captures[1]]
    end) -- only change globals where they're used at least twice, or it's a cost
