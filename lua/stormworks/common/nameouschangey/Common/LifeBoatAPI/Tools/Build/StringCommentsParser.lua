...
require("stormworks.common.nameouschangey.Common.LifeBoatAPI.Tools.Build.StringReplacer")
require("stormworks.common.nameouschangey.Common.LifeBoatAPI.Tools.Build.CommentReplacer")
