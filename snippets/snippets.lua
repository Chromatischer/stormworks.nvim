-- sw-micro-project: dynamic LuaSnip registration from VSCode-style JSON
-- This module loads snippets from ./sw-micro-project.json and registers them
...
local function notify(msg, level)
  ...
  if vim and vim.notify then
    vim.notify("sw-micro-project.snippets: " .. msg, level)
  else
    print("sw-micro-project.snippets: " .. msg)
  end
end
...
local function get_json_path()
  ...
  return dir .. "sw-micro-project.json"
end
...
function M.load()
  ...
  ls.add_snippets("lua", snippets, { key = "sw-micro-project" })
end
